...
public class EntityRegistry {
    ...
    public static final RegistrySupplier<EntityType<LaserEntity>> LASER = ENTITY_TYPES.register("laser",() -> EntityType.Builder.<LaserEntity>of(LaserEntity::new, MobCategory.MISC).fireImmune().sized(0.4f, 0.4f).build(ResourceLocation.fromNamespaceAndPath(SWPlanets.MODID, "laser").toString()));
    ...
    public static void registerSpawnPlacements() {
        SpawnPlacementsRegistry.register(BANTHA, SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, BanthaEntity::checkMobSpawnRules);
        SpawnPlacementsRegistry.register(JAWA, SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, JawaEntity::checkMobSpawnRules);
    }
}
