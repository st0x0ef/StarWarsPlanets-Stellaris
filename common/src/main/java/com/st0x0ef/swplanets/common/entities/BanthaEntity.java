...
public class BanthaEntity extends AbstractHorse implements PlayerRideableJumping, Saddleable {
    ...
    protected Vec3 getPassengerAttachmentPoint(Entity entity, EntityDimensions dimensions, float scale) {
        ...
        return new Vec3(0.0F, g, f * scale);
    }
    ...
    public Vec3 getLeashOffset(float partialTick) {
        ...
        return new Vec3(0.0, this.getBodyAnchorAnimationYOffset(true, partialTick, entityDimensions, f) - (double)(0.2F * f), entityDimensions.width() * 0.56F);
    }
