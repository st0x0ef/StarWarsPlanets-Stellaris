...
public class BlockEntitiesRegistry {
    ...
    public static final RegistrySupplier<BlockEntityType<?>> BLASTER_UPGRADER = BLOCK_ENTITY_TYPES.register("blaster_upgrader",
            () -> BlockEntityType.Builder.of(BlasterUpgraderBlockEntity::new, BlocksRegistry.BLASTER_UPGRADER.get()).build(null));
