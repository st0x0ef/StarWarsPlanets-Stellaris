...
public class FabricSWPlanetsClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        FabricLoader.getInstance().getModContainer(Constants.MODID).ifPresent(modContainer -> ResourceManagerHelper.registerBuiltinResourcePack(new ResourceLocation("swplanets:old_lightsabers_models"), modContainer, ResourcePackActivationType.NORMAL));
    }
}
